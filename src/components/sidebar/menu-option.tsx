...
const MenuOption = ({
  ...
  useEffect(() => {
    setIsMounted(true); //only when the component is mounted we will show the side bar
  }, []);
    ...
    <Sheet modal={false} {...openState}>
      ...
      >
        <div>
          ...
          {/* popover section that plays an important role in creating a dropdown menu  */}
          <Popover>
            {/* This Popover Trigger showing the Ui before Dropdown  */}
            {/**We have
             * Button
             * inside the Button :- {compass icon,Name + address, upDownmenu icon}
             */}
